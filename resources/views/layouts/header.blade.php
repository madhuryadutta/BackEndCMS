...
<head>
    ...
    <title>@lang('dictionary.BackendCMS')</title>
    <meta content="" name="description">
    <meta content="" name="keywords">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Favicons -->
    <link href="https://databytedigital.com/image/logo.png" rel="icon">
    <link href="https://databytedigital.com/image/logo.png" rel="apple-touch-icon">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                <img src="https://databytedigital.com/image/logo.png" height="26" width="26"
                    alt="@lang('dictionary.BackendCMS')">
